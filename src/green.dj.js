		...
		function GreenDjObject() {
			...
			this.init = function() {
				$('#chat-header').find('.divider').after('<div class="chat-header-button" style="margin-left: 13px; margin-right: 0;" onclick="greenDj.onSettingsClick()">' +
					'<i class="icon icon-settings-white" onmouseover="$(this).toggleClass(\'icon-settings-grey icon-settings-white\')" onmouseout="$(this).toggleClass(\'icon-settings-grey icon-settings-white\')"></i>' +
					'</div>');
